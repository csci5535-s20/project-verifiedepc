...
extern void ivy_assert(bool,const char *);
extern void ivy_assume(bool,const char *);
extern void ivy_check_progress(int,int);
...
public:
    virtual bool generate(sctp_impl& obj)=0;
    virtual void execute(sctp_impl& obj)=0;
    virtual ~gen(){}
...
public:
    init_gen();
    bool generate(sctp_impl&);
    void execute(sctp_impl&){}
};
