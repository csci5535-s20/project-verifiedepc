...
class initial_ue_message_test {
  public:
    ...
    virtual ~initial_ue_message_test();
    ...
    enum nas_pdu_string{nas_pdu_string__0,nas_pdu_string__a,nas_pdu_string__b,nas_pdu_string__c,nas_pdu_string__d,nas_pdu_string__e,nas_pdu_string__f,nas_pdu_string__g,nas_pdu_string__h,nas_pdu_string__i,nas_pdu_string__j,nas_pdu_string__k,nas_pdu_string__l,nas_pdu_string__m,nas_pdu_string__n,nas_pdu_string__o,nas_pdu_string__p,nas_pdu_string__q,nas_pdu_string__r,nas_pdu_string__s,nas_pdu_string__t,nas_pdu_string__u,nas_pdu_string__v,nas_pdu_string__w,nas_pdu_string__x,nas_pdu_string__y,nas_pdu_string__z};
    enum message_enum{message_enum__initial_message,message_enum__successful_outcome,message_enum__unsuccessful_outcome};
    enum rrc_enum{rrc_enum__0,rrc_enum__emergency,rrc_enum__highPriorityAccess,rrc_enum__mt_Access,rrc_enum__mo_Signalling};
    unsigned initial_ue_message__plmn_identity2;
    unsigned initial_ue_message__tac;
    unsigned initial_ue_message__plmn_identity1;
    unsigned initial_ue_message__pcode;
    bool _generating;
    message_enum initial_ue_message__msg;
    int initial_ue_message__enb_ue_s1ap_id;
    nas_pdu_string initial_ue_message__nas_pdu;
    unsigned initial_ue_message__cell_identity;
    rrc_enum initial_ue_message__rrc_establishment_cause;
    long long __CARD__pcode_bits;
    long long __CARD__plmn_octet;
    long long __CARD__tac_octet;
    long long __CARD__cell_bits;
    long long __CARD__cid;
    initial_ue_message_test();
    virtual void __init();
    virtual message_enum ext__initial_ue_message__recv();
    virtual bool ext__ask_and_check_pcode();
    virtual unsigned imp__ask();
    virtual unsigned ext__ask();
    virtual void ext__initial_ue_message__send(unsigned x, message_enum y, int e, nas_pdu_string n, unsigned p1, unsigned t, unsigned p2, unsigned c, rrc_enum r);
