#include "downlink_nas_transport_test.h"
...
#include <cstdint>
#endif
typedef downlink_nas_transport_test ivy_class;
...
void downlink_nas_transport_test::install_reader(reader *r) {
    #ifdef _WIN32
...
void downlink_nas_transport_test::install_thread(reader *r) {
    install_reader(r);
}

void downlink_nas_transport_test::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void downlink_nas_transport_test::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void downlink_nas_transport_test::__unlock() { ReleaseMutex(mutex); }
#else
    void downlink_nas_transport_test::__lock() { pthread_mutex_lock(&mutex); }
    void downlink_nas_transport_test::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const downlink_nas_transport_test::message_enum &t);
template <>
downlink_nas_transport_test::message_enum _arg<downlink_nas_transport_test::message_enum>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<downlink_nas_transport_test::message_enum>(ivy_ser &res, const downlink_nas_transport_test::message_enum&);
template <>
void  __deser<downlink_nas_transport_test::message_enum>(ivy_deser &inp, downlink_nas_transport_test::message_enum &res);
std::ostream &operator <<(std::ostream &s, const downlink_nas_transport_test::nas_pdu_string &t);
template <>
downlink_nas_transport_test::nas_pdu_string _arg<downlink_nas_transport_test::nas_pdu_string>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<downlink_nas_transport_test::nas_pdu_string>(ivy_ser &res, const downlink_nas_transport_test::nas_pdu_string&);
template <>
void  __deser<downlink_nas_transport_test::nas_pdu_string>(ivy_deser &inp, downlink_nas_transport_test::nas_pdu_string &res);
...
void downlink_nas_transport_test::__init(){
    {
        {
            downlink_nas_transport__pcode = (0 & 255);
            downlink_nas_transport__msg = message_enum__unsuccessful_outcome;
            downlink_nas_transport__mme_ue_s1ap_id = 0;
            downlink_nas_transport__enb_ue_s1ap_id = 0;
            downlink_nas_transport__nas_pdu = nas_pdu_string__0;
        }
    }
}
bool downlink_nas_transport_test::ext__ask_and_check_pcode(){
    bool ok;
...
unsigned downlink_nas_transport_test::imp__ask(){
    unsigned x;
    x = (unsigned)___ivy_choose(0,"fml:x",0);
    {
    }
...
void downlink_nas_transport_test::__tick(int __timeout){
}
downlink_nas_transport_test::downlink_nas_transport_test(){
#ifdef _WIN32
...
__lock();
    ...
    downlink_nas_transport__msg = (message_enum)___ivy_choose(0,"init",0);
    downlink_nas_transport__mme_ue_s1ap_id = (int)___ivy_choose(0,"init",0);
    downlink_nas_transport__nas_pdu = (nas_pdu_string)___ivy_choose(0,"init",0);
    downlink_nas_transport__pcode = (unsigned)___ivy_choose(0,"init",0);
    downlink_nas_transport__enb_ue_s1ap_id = (int)___ivy_choose(0,"init",0);
}
downlink_nas_transport_test::~downlink_nas_transport_test(){
...
std::ostream &operator <<(std::ostream &s, const downlink_nas_transport_test::message_enum &t){
    if (t == downlink_nas_transport_test::message_enum__initial_message) s<<"initial_message";
    if (t == downlink_nas_transport_test::message_enum__successful_outcome) s<<"successful_outcome";
    if (t == downlink_nas_transport_test::message_enum__unsuccessful_outcome) s<<"unsuccessful_outcome";
    return s;
}
template <>
void  __ser<downlink_nas_transport_test::message_enum>(ivy_ser &res, const downlink_nas_transport_test::message_enum&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const downlink_nas_transport_test::nas_pdu_string &t){
    if (t == downlink_nas_transport_test::nas_pdu_string__0) s<<"0";
    if (t == downlink_nas_transport_test::nas_pdu_string__a) s<<"a";
    if (t == downlink_nas_transport_test::nas_pdu_string__b) s<<"b";
    if (t == downlink_nas_transport_test::nas_pdu_string__c) s<<"c";
    if (t == downlink_nas_transport_test::nas_pdu_string__d) s<<"d";
    if (t == downlink_nas_transport_test::nas_pdu_string__e) s<<"e";
    if (t == downlink_nas_transport_test::nas_pdu_string__f) s<<"f";
    if (t == downlink_nas_transport_test::nas_pdu_string__g) s<<"g";
    if (t == downlink_nas_transport_test::nas_pdu_string__h) s<<"h";
    if (t == downlink_nas_transport_test::nas_pdu_string__i) s<<"i";
    if (t == downlink_nas_transport_test::nas_pdu_string__j) s<<"j";
    if (t == downlink_nas_transport_test::nas_pdu_string__k) s<<"k";
    if (t == downlink_nas_transport_test::nas_pdu_string__l) s<<"l";
    if (t == downlink_nas_transport_test::nas_pdu_string__m) s<<"m";
    if (t == downlink_nas_transport_test::nas_pdu_string__n) s<<"n";
    if (t == downlink_nas_transport_test::nas_pdu_string__o) s<<"o";
    if (t == downlink_nas_transport_test::nas_pdu_string__p) s<<"p";
    if (t == downlink_nas_transport_test::nas_pdu_string__q) s<<"q";
    if (t == downlink_nas_transport_test::nas_pdu_string__r) s<<"r";
    if (t == downlink_nas_transport_test::nas_pdu_string__s) s<<"s";
    if (t == downlink_nas_transport_test::nas_pdu_string__t) s<<"t";
    if (t == downlink_nas_transport_test::nas_pdu_string__u) s<<"u";
    if (t == downlink_nas_transport_test::nas_pdu_string__v) s<<"v";
    if (t == downlink_nas_transport_test::nas_pdu_string__w) s<<"w";
    if (t == downlink_nas_transport_test::nas_pdu_string__x) s<<"x";
    if (t == downlink_nas_transport_test::nas_pdu_string__y) s<<"y";
    if (t == downlink_nas_transport_test::nas_pdu_string__z) s<<"z";
    return s;
}
template <>
void  __ser<downlink_nas_transport_test::nas_pdu_string>(ivy_ser &res, const downlink_nas_transport_test::nas_pdu_string&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class downlink_nas_transport_test_repl : public downlink_nas_transport_test {
    ...
    downlink_nas_transport_test_repl() : downlink_nas_transport_test(){}
...
downlink_nas_transport_test::message_enum _arg<downlink_nas_transport_test::message_enum>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "initial_message") return downlink_nas_transport_test::message_enum__initial_message;
    if(arg.atom == "successful_outcome") return downlink_nas_transport_test::message_enum__successful_outcome;
    if(arg.atom == "unsuccessful_outcome") return downlink_nas_transport_test::message_enum__unsuccessful_outcome;
...
void __deser<downlink_nas_transport_test::message_enum>(ivy_deser &inp, downlink_nas_transport_test::message_enum &res){
    int __res;
    __deser(inp,__res);
    res = (downlink_nas_transport_test::message_enum)__res;
}
template <>
downlink_nas_transport_test::nas_pdu_string _arg<downlink_nas_transport_test::nas_pdu_string>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "0") return downlink_nas_transport_test::nas_pdu_string__0;
    if(arg.atom == "a") return downlink_nas_transport_test::nas_pdu_string__a;
    if(arg.atom == "b") return downlink_nas_transport_test::nas_pdu_string__b;
    if(arg.atom == "c") return downlink_nas_transport_test::nas_pdu_string__c;
    if(arg.atom == "d") return downlink_nas_transport_test::nas_pdu_string__d;
    if(arg.atom == "e") return downlink_nas_transport_test::nas_pdu_string__e;
    if(arg.atom == "f") return downlink_nas_transport_test::nas_pdu_string__f;
    if(arg.atom == "g") return downlink_nas_transport_test::nas_pdu_string__g;
    if(arg.atom == "h") return downlink_nas_transport_test::nas_pdu_string__h;
    if(arg.atom == "i") return downlink_nas_transport_test::nas_pdu_string__i;
    if(arg.atom == "j") return downlink_nas_transport_test::nas_pdu_string__j;
    if(arg.atom == "k") return downlink_nas_transport_test::nas_pdu_string__k;
    if(arg.atom == "l") return downlink_nas_transport_test::nas_pdu_string__l;
    if(arg.atom == "m") return downlink_nas_transport_test::nas_pdu_string__m;
    if(arg.atom == "n") return downlink_nas_transport_test::nas_pdu_string__n;
    if(arg.atom == "o") return downlink_nas_transport_test::nas_pdu_string__o;
    if(arg.atom == "p") return downlink_nas_transport_test::nas_pdu_string__p;
    if(arg.atom == "q") return downlink_nas_transport_test::nas_pdu_string__q;
    if(arg.atom == "r") return downlink_nas_transport_test::nas_pdu_string__r;
    if(arg.atom == "s") return downlink_nas_transport_test::nas_pdu_string__s;
    if(arg.atom == "t") return downlink_nas_transport_test::nas_pdu_string__t;
    if(arg.atom == "u") return downlink_nas_transport_test::nas_pdu_string__u;
    if(arg.atom == "v") return downlink_nas_transport_test::nas_pdu_string__v;
    if(arg.atom == "w") return downlink_nas_transport_test::nas_pdu_string__w;
    if(arg.atom == "x") return downlink_nas_transport_test::nas_pdu_string__x;
    if(arg.atom == "y") return downlink_nas_transport_test::nas_pdu_string__y;
    if(arg.atom == "z") return downlink_nas_transport_test::nas_pdu_string__z;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<downlink_nas_transport_test::nas_pdu_string>(ivy_deser &inp, downlink_nas_transport_test::nas_pdu_string &res){
    int __res;
    __deser(inp,__res);
    res = (downlink_nas_transport_test::nas_pdu_string)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    downlink_nas_transport_test_repl &ivy;    

    cmd_reader(downlink_nas_transport_test_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: downlink_nas_transport_test \n";
        __ivy_exit(1);
    }
