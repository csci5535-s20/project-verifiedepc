...
class s1_setup_test3 {
  public:
    ...
    virtual unsigned long long supported_ta__arr__begin(const supported_ta__arr& A);
    ...
    s1_setup_test3();
    virtual void ext__s1_setup__send(unsigned x, message_enum y, unsigned a, unsigned b, drx_enum c, supported_ta__arr s);
...
inline bool operator ==(const s1_setup_test3::supported_ta &s, const s1_setup_test3::supported_ta &t){
