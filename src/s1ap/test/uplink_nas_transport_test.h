...
class uplink_nas_transport_test {
  public:
    ...
    virtual ~uplink_nas_transport_test();
    ...
    bool _generating;
    unsigned uplink_nas_transport__cell_identity;
    unsigned uplink_nas_transport__plmn_identity1;
    int uplink_nas_transport__enb_ue_s1ap_id;
    unsigned uplink_nas_transport__plmn_identity2;
    message_enum uplink_nas_transport__msg;
    nas_pdu_string uplink_nas_transport__nas_pdu;
    int uplink_nas_transport__mme_ue_s1ap_id;
    unsigned uplink_nas_transport__tac;
    unsigned uplink_nas_transport__pcode;
    ...
    uplink_nas_transport_test();
    virtual message_enum ext__uplink_nas_transport__recv();
    virtual void __init();
    virtual bool ext__ask_and_check_pcode();
    virtual void ext__uplink_nas_transport__send(unsigned x, message_enum y, int m, int e, nas_pdu_string n, unsigned a, unsigned b, unsigned c, unsigned d);
