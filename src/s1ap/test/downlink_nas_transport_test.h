...
class downlink_nas_transport_test {
  public:
    ...
    virtual ~downlink_nas_transport_test();
    ...
    bool _generating;
    message_enum downlink_nas_transport__msg;
    int downlink_nas_transport__mme_ue_s1ap_id;
    nas_pdu_string downlink_nas_transport__nas_pdu;
    unsigned downlink_nas_transport__pcode;
    int downlink_nas_transport__enb_ue_s1ap_id;
